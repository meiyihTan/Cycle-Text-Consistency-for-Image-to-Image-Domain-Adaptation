...
import utils
from unet_seg import CA_seg_UNet
...
checkpoint_dir = './IC15_004_results/result_IC15_baseline_seg_CA_msssim/'
...
for epoch in tqdm(range(lastepoch, 4001)):
    ...
    for sample in iter(dataloader):
        ...
        loss =1.75*mae_loss+0.25*seg_loss+ 0.15*ms_ssim_loss
        loss.backward()
        G_opt.step()
