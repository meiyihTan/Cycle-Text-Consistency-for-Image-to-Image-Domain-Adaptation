...
import torchvision
from unet import gray_TA_CA_seg_UNet
...
checkpoint_dir = './IC15_004_results/result_IC15_baseline_gray_seg_TA_CA_msssim_text_detection/'
...
with torch.no_grad():
    ...
    for test_id in test_ids:
        ...
        Image.fromarray((output * 25).astype('uint8')).convert('RGB').save(result_dir + 'final_result_mul25/%d.jpg' % (test_id))
