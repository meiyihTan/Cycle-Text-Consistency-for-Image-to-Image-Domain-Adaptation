...
from curved_tiou.rrc_evaluation_funcs import *
import importlib
import sys
...
def validate_data(gtFilePath, submFilePath,evaluationParams):
    ...
    for k in subm:
        ...
        validate_lines_in_file(k,subm[k],evaluationParams['CRLF'],evaluationParams['LTRB'],withTranscription=False,withConfidence=evaluationParams['CONFIDENCES'])
