...
import utils
from unet_seg import gray_CBAM_TA_CA_seg_UNet
from dataset.ICDAR15_seg import ICDAR15Dataset_seg
...
checkpoint_dir = './IC15_004_results/result_IC15_baseline_gray_seg_TA_CBAM_CA_msssim_text_detection/'
...
dataset = ICDAR15Dataset_seg(list_file = list_file, root_dir = './dataset/', ps=ps)
